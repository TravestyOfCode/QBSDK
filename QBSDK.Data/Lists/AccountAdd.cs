...
public class AccountAdd
{
    ...
    public XElement ToQBXML(QBVersion version = default, string name = nameof(AccountAdd))
    {
        return new XElement("AccountAddRq", new XElement(name)
            .Append(Name)
            .Append(IsActive)
            .Append(ParentRef)
            .Append(AccountType)
...
public static class AccountAddExtensions
{
    public static AccountAdd AsAdd(this Account entity)
    {
        ArgumentNullException.ThrowIfNull(entity);
        ArgumentNullException.ThrowIfNull(entity.Name);
        ArgumentNullException.ThrowIfNull(entity.AccountType);
