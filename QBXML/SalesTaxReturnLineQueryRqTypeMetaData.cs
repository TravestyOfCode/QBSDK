...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("SalesTaxReturnLineQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum SalesTaxReturnLineQueryRqTypeMetaData
    {
