...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("DateDrivenTermsQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum DateDrivenTermsQueryRqTypeMetaData
    {
