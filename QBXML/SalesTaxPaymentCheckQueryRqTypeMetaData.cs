...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("SalesTaxPaymentCheckQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum SalesTaxPaymentCheckQueryRqTypeMetaData
    {
