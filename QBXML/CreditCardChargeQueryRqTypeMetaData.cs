...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("CreditCardChargeQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum CreditCardChargeQueryRqTypeMetaData
    {
