...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("WorkersCompCodeQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum WorkersCompCodeQueryRqTypeMetaData
    {
