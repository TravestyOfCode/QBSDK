...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ItemNonInventoryQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum ItemNonInventoryQueryRqTypeMetaData
    {
