...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("CreditCardCreditQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum CreditCardCreditQueryRqTypeMetaData
    {
