...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("PayrollLiabilityCheckQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum PayrollLiabilityCheckQueryRqTypeMetaData
    {
