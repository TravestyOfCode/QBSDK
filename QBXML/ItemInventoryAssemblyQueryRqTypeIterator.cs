...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ItemInventoryAssemblyQueryRqTypeIterator", Namespace="", AnonymousType=true)]
    public enum ItemInventoryAssemblyQueryRqTypeIterator
    {
