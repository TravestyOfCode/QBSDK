...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("VisibleIfNot", Namespace="", AnonymousType=true)]
    [System.Xml.Serialization.XmlRootAttribute("VisibleIfNot", Namespace="")]
    public enum VisibleIfNot
    {
        
        AccountantCopyExists,
        
        AssemblyItemsEnabled,
