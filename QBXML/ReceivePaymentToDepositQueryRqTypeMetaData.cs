...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ReceivePaymentToDepositQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum ReceivePaymentToDepositQueryRqTypeMetaData
    {
