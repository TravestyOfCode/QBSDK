...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("BillPaymentCheckQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum BillPaymentCheckQueryRqTypeMetaData
    {
