...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("PayrollYearToDateAdjustmentQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum PayrollYearToDateAdjustmentQueryRqTypeMetaData
    {
