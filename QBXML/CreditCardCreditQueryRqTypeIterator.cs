...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("CreditCardCreditQueryRqTypeIterator", Namespace="", AnonymousType=true)]
    public enum CreditCardCreditQueryRqTypeIterator
    {
