...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("PayrollItemWageQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum PayrollItemWageQueryRqTypeMetaData
    {
