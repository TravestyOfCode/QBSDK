...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ARRefundCreditCardQueryRqTypeIterator", Namespace="", AnonymousType=true)]
    public enum ARRefundCreditCardQueryRqTypeIterator
    {
