...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("TransferInventoryQueryRqTypeIterator", Namespace="", AnonymousType=true)]
    public enum TransferInventoryQueryRqTypeIterator
    {
