...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("SalesTaxPaymentCheckQueryRqTypeIterator", Namespace="", AnonymousType=true)]
    public enum SalesTaxPaymentCheckQueryRqTypeIterator
    {
