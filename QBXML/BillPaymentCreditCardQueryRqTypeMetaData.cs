...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("BillPaymentCreditCardQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum BillPaymentCreditCardQueryRqTypeMetaData
    {
