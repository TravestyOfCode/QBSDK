...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("BillPaymentCreditCardQueryRqTypeIterator", Namespace="", AnonymousType=true)]
    public enum BillPaymentCreditCardQueryRqTypeIterator
    {
