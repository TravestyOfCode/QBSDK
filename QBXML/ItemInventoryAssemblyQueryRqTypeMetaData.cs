...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ItemInventoryAssemblyQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum ItemInventoryAssemblyQueryRqTypeMetaData
    {
