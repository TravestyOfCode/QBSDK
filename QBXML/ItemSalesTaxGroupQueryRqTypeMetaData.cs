...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ItemSalesTaxGroupQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum ItemSalesTaxGroupQueryRqTypeMetaData
    {
