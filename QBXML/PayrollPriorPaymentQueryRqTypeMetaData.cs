...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("PayrollPriorPaymentQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum PayrollPriorPaymentQueryRqTypeMetaData
    {
