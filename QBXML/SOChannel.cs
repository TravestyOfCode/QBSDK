...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("SOChannel", Namespace="", AnonymousType=true)]
    [System.Xml.Serialization.XmlRootAttribute("SOChannel", Namespace="")]
    public enum SOChannel
    {
