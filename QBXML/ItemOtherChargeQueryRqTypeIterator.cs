...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ItemOtherChargeQueryRqTypeIterator", Namespace="", AnonymousType=true)]
    public enum ItemOtherChargeQueryRqTypeIterator
    {
