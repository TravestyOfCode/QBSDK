...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("CreditCardChargeQueryRqTypeIterator", Namespace="", AnonymousType=true)]
    public enum CreditCardChargeQueryRqTypeIterator
    {
