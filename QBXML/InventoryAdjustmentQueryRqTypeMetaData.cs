...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("InventoryAdjustmentQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum InventoryAdjustmentQueryRqTypeMetaData
    {
