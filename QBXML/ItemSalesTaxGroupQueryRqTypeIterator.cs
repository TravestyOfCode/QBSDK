...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ItemSalesTaxGroupQueryRqTypeIterator", Namespace="", AnonymousType=true)]
    public enum ItemSalesTaxGroupQueryRqTypeIterator
    {
