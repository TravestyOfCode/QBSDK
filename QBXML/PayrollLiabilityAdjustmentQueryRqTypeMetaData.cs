...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("PayrollLiabilityAdjustmentQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum PayrollLiabilityAdjustmentQueryRqTypeMetaData
    {
