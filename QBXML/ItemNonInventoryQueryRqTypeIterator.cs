...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ItemNonInventoryQueryRqTypeIterator", Namespace="", AnonymousType=true)]
    public enum ItemNonInventoryQueryRqTypeIterator
    {
