...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("SalesTaxPayableQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum SalesTaxPayableQueryRqTypeMetaData
    {
