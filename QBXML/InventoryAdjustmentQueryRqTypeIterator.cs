...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("InventoryAdjustmentQueryRqTypeIterator", Namespace="", AnonymousType=true)]
    public enum InventoryAdjustmentQueryRqTypeIterator
    {
