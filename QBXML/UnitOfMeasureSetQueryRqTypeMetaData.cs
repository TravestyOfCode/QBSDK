...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("UnitOfMeasureSetQueryRqTypeMetaData", Namespace="", AnonymousType=true)]
    public enum UnitOfMeasureSetQueryRqTypeMetaData
    {
