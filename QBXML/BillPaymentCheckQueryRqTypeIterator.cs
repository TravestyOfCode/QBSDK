...
namespace QBXML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("BillPaymentCheckQueryRqTypeIterator", Namespace="", AnonymousType=true)]
    public enum BillPaymentCheckQueryRqTypeIterator
    {
