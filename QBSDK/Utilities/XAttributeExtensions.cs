...
internal static class XAttributeExtensions
{
    ...
    public static void SetFromAttribute(this XElement? element, long? value, [CallerArgumentExpression(nameof(value))] string name = "")
    {
        value = long.TryParse(element?.Attribute(name)?.Value, out var result) ? result : null;
    }
    public static void SetFromAttribute(this XElement? element, int? value, [CallerArgumentExpression(nameof(value))] string name = "")
    {
        value = int.TryParse(element?.Attribute(name)?.Value, out var result) ? result : null;
    }
    public static void SetFromAttribute(this XElement? element, string? value, [CallerArgumentExpression(nameof(value))] string name = "")
    {
